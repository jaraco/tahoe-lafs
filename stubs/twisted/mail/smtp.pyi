...
class ESMTPSenderFactory(SMTPSenderFactory):
    ...
    username: Any = ...
    password: Any = ...
    def __init__(self, username: Any, password: Any, fromEmail: Any, toEmail: Any, file: Any, deferred: Any, retries: int = ..., timeout: Optional[Any] = ..., contextFactory: Optional[Any] = ..., heloFallback: bool = ..., requireAuthentication: bool = ..., requireTransportSecurity: bool = ..., hostname: Optional[Any] = ...) -> None: ...
    currentProtocol: Any = ...
    def buildProtocol(self, addr: Any): ...
