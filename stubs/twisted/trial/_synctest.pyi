...
from twisted.python.deprecate import DEPRECATION_WARNING_FORMAT as DEPRECATION_WARNING_FORMAT, getDeprecationWarningString as getDeprecationWarningString, getVersionString as getVersionString, warnAboutFunction as warnAboutFunction
...
class _Assertions(pyunit.TestCase):
    ...
    failIfIn: Any = ...
    def assertNotAlmostEqual(self, first: Any, second: Any, places: int = ..., msg: Optional[Any] = ..., delta: Optional[Any] = ...): ...
    assertNotAlmostEquals: Any = ...
    failIfAlmostEqual: Any = ...
    failIfAlmostEquals: Any = ...
    def assertAlmostEqual(self, first: Any, second: Any, places: int = ..., msg: Optional[Any] = ..., delta: Optional[Any] = ...): ...
...
class SynchronousTestCase(_Assertions):
    ...
    def getDeprecatedModuleAttribute(self, moduleName: Any, name: Any, version: Any, message: Optional[Any] = ...): ...
