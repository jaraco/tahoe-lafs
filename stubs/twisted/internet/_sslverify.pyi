...
def optionsForClientTLS(hostname: Any, trustRoot: Optional[Any] = ..., clientCertificate: Optional[Any] = ..., acceptableProtocols: Optional[Any] = ..., *, extraCertificateOptions: Optional[Any] = ...): ...
