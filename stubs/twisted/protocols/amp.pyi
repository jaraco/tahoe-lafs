...
class Command:
    ...
    commandType: Union[Type[Command], Type[Box]] = ...
    responseType: Type[AmpBox] = ...
    requiresAnswer: bool = ...
    structured: Any = ...
...
class StartTLS(Command):
    ...
    certificate: Any = ...
    authorities: Any = ...
    def __init__(self, *, tls_localCertificate: Optional[Any] = ..., tls_verifyAuthorities: Optional[Any] = ..., **kw: Any) -> None: ...
...
class BinaryBoxProtocol(StatefulStringProtocol, Int16StringReceiver, _DescriptorExchanger):
    ...
    innerProtocol: Optional[Protocol] = ...
